...
(function () {
  ...
  const PLAYERS = [
    ...
    P({name:"Mateo Rivas",     pos:"FW", posFull:"Forward",      age:21, nation:"Argentina",  club:"Atlético Verano",   leagueId:"por1",    mv:"€42.0M", mvNum:42,   expiry:"2027-06", status:"Active",        agent:"Donte Dorlly",   rating:7.9, apps:28, goals:19, assists:7,  passAcc:81, mins:2380, height:"1.83m", foot:"Right", tier:"elite",   form:1.6}),
    P({name:"Luka Veselin",    pos:"MF", posFull:"Att. Midfield", age:23, nation:"Croatia",    club:"Olympia Nord",      leagueId:"den1",    mv:"€31.5M", mvNum:31.5, expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",    rating:7.6, apps:31, goals:8,  assists:14, passAcc:89, mins:2710, height:"1.79m", foot:"Left",  tier:"key",     form:1.1}),
    P({name:"Idriss Camara",   pos:"DF", posFull:"Centre-Back",  age:24, nation:"Senegal",    club:"Ribera CF",         leagueId:"esp2",    mv:"€24.0M", mvNum:24,   expiry:"2025-12", status:"Contract Risk", agent:"Donte Dorlly",   rating:7.3, apps:30, goals:2,  assists:1,  passAcc:91, mins:2700, height:"1.91m", foot:"Right", tier:"key",     form:0.5}),
    P({name:"Théo Lamballe",   pos:"GK", posFull:"Goalkeeper",   age:26, nation:"France",     club:"Meridian City",     leagueId:"bel1",    mv:"€18.5M", mvNum:18.5, expiry:"2028-06", status:"Active",        agent:"Donte Dorlly",    rating:7.4, apps:29, goals:0,  assists:0,  passAcc:78, mins:2610, height:"1.94m", foot:"Right", tier:"key",     form:0.3}),
    P({name:"Bruno Sável",     pos:"FW", posFull:"Winger",       age:19, nation:"Portugal",   club:"Falcão SC",         leagueId:"por2",    mv:"€15.0M", mvNum:15,   expiry:"2027-06", status:"Prospect",      agent:"Donte Dorlly", rating:7.1, apps:24, goals:9,  assists:11, passAcc:83, mins:1980, height:"1.75m", foot:"Right", tier:"prospect",form:2.1}),
    P({name:"Adewale Okoye",   pos:"MF", posFull:"Def. Midfield",age:22, nation:"Nigeria",    club:"Vallensa United",   leagueId:"ned2",    mv:"€22.0M", mvNum:22,   expiry:"2026-12", status:"Active",        agent:"Donte Dorlly",   rating:7.5, apps:33, goals:3,  assists:5,  passAcc:88, mins:2890, height:"1.85m", foot:"Right", tier:"key",     form:0.8}),
    P({name:"Niklas Brandt",   pos:"DF", posFull:"Right-Back",   age:25, nation:"Germany",    club:"Köln Adler",        leagueId:"ger2",    mv:"€16.5M", mvNum:16.5, expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",    rating:7.2, apps:27, goals:1,  assists:6,  passAcc:85, mins:2380, height:"1.81m", foot:"Right", tier:"squad",   form:0.6}),
    P({name:"Rafael Pinto",    pos:"FW", posFull:"Striker",      age:28, nation:"Brazil",     club:"Porto Azul",        leagueId:"por1",    mv:"€28.0M", mvNum:28,   expiry:"2025-06", status:"Contract Risk", agent:"Donte Dorlly", rating:7.7, apps:30, goals:21, assists:4,  passAcc:79, mins:2540, height:"1.88m", foot:"Left",  tier:"key",     form:0.9}),
    P({name:"Joel Hartman",    pos:"MF", posFull:"Central Mid",  age:20, nation:"England",    club:"Highmoor FC",       leagueId:"swe1",    mv:"€19.0M", mvNum:19,   expiry:"2028-06", status:"Prospect",      agent:"Donte Dorlly",   rating:7.0, apps:22, goals:4,  assists:8,  passAcc:86, mins:1760, height:"1.80m", foot:"Right", tier:"prospect",form:1.8}),
    P({name:"Diego Marín",     pos:"DF", posFull:"Centre-Back",  age:27, nation:"Spain",      club:"Cádiz Marina",      leagueId:"esp2",    mv:"€12.0M", mvNum:12,   expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",    rating:7.1, apps:28, goals:3,  assists:0,  passAcc:90, mins:2520, height:"1.89m", foot:"Right", tier:"squad",   form:0.4}),
    P({name:"Yuki Tanabe",     pos:"MF", posFull:"Winger",       age:21, nation:"Japan",      club:"Vento FC",          leagueId:"aut1",    mv:"€17.5M", mvNum:17.5, expiry:"2027-06", status:"Active",        agent:"Donte Dorlly", rating:7.3, apps:29, goals:7,  assists:10, passAcc:84, mins:2340, height:"1.72m", foot:"Left",  tier:"key",     form:1.4}),
    P({name:"Karim El Fassi",  pos:"FW", posFull:"Forward",      age:23, nation:"Morocco",    club:"Lyonne AC",         leagueId:"fra3",    mv:"€26.5M", mvNum:26.5, expiry:"2027-12", status:"Active",        agent:"Donte Dorlly",   rating:7.6, apps:31, goals:15, assists:9,  passAcc:82, mins:2680, height:"1.84m", foot:"Right", tier:"key",     form:1.3}),
    P({name:"Anton Skov",      pos:"FW", posFull:"Striker",      age:18, nation:"Norway",     club:"Nordvik IF",        leagueId:"den1",    mv:"€9.5M",  mvNum:9.5,  expiry:"2027-06", status:"Prospect",      agent:"Donte Dorlly", rating:6.9, apps:19, goals:11, assists:3,  passAcc:77, mins:1480, height:"1.90m", foot:"Right", tier:"prospect",form:2.4}),
    P({name:"Felipe Andrade",  pos:"DF", posFull:"Left-Back",    age:24, nation:"Brazil",     club:"Delta Lagos",       leagueId:"lat1",    mv:"€14.0M", mvNum:14,   expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",    rating:7.0, apps:26, goals:2,  assists:7,  passAcc:84, mins:2300, height:"1.78m", foot:"Left",  tier:"squad",   form:0.7}),
    P({name:"Sergio Bonilla",  pos:"MF", posFull:"Att. Midfield",age:26, nation:"Colombia",   club:"Estrella Roja",     leagueId:"esp3",    mv:"€20.5M", mvNum:20.5, expiry:"2025-12", status:"Contract Risk", agent:"Donte Dorlly",   rating:7.4, apps:30, goals:10, assists:12, passAcc:87, mins:2610, height:"1.76m", foot:"Right", tier:"key",     form:0.6}),
    P({name:"Lars Ophoven",    pos:"DF", posFull:"Centre-Back",  age:22, nation:"Netherlands",club:"Borges United",     leagueId:"ned2",    mv:"€13.5M", mvNum:13.5, expiry:"2028-06", status:"Prospect",      agent:"Donte Dorlly", rating:7.0, apps:25, goals:1,  assists:2,  passAcc:89, mins:2200, height:"1.92m", foot:"Left",  tier:"prospect",form:1.5}),
    P({name:"Emiliano Sosa",   pos:"GK", posFull:"Goalkeeper",   age:29, nation:"Uruguay",    club:"Saint-Croix",       leagueId:"bel2",    mv:"€10.0M", mvNum:10,   expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",    rating:7.2, apps:30, goals:0,  assists:0,  passAcc:75, mins:2700, height:"1.93m", foot:"Right", tier:"squad",   form:0.2}),
    P({name:"Gabriel Nunes",   pos:"FW", posFull:"Winger",       age:20, nation:"Brazil",     club:"Maple Rovers",      leagueId:"swe1",    mv:"€21.0M", mvNum:21,   expiry:"2027-06", status:"Active",        agent:"Donte Dorlly",   rating:7.4, apps:27, goals:12, assists:8,  passAcc:80, mins:2280, height:"1.74m", foot:"Right", tier:"key",     form:1.7}),
    ...
    P({name:"Cheick Oumar Konaté", pos:"DF", posFull:"Centre-Back",  age:25, nation:"Mali",         club:"A.E. Kifisia",      leagueId:"gre2",  mv:"€1.2M", mvNum:1.2,  expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",   rating:7.0, apps:24, goals:1,  assists:1,  passAcc:85, mins:2100, height:"1.88m", foot:"Right", tier:"squad",   form:0.6}),
    P({name:"Khuliso Mudau",       pos:"DF", posFull:"Right-Back",    age:27, nation:"South Africa", club:"Mamelodi Sundowns", leagueId:"rsa1",  mv:"€1.8M", mvNum:1.8,  expiry:"2026-12", status:"Active",        agent:"Donte Dorlly",   rating:7.2, apps:28, goals:2,  assists:6,  passAcc:84, mins:2380, height:"1.79m", foot:"Right", tier:"key",     form:0.8}),
    P({name:"Bongani Zungu",       pos:"MF", posFull:"Central Mid",   age:31, nation:"South Africa", club:"Amazulu F.C",       leagueId:"rsa1",  mv:"€1.5M", mvNum:1.5,  expiry:"2025-12", status:"Contract Risk", agent:"Donte Dorlly",   rating:7.3, apps:29, goals:4,  assists:8,  passAcc:87, mins:2510, height:"1.78m", foot:"Right", tier:"key",     form:0.6}),
    P({name:"Bathusi Aubaas",      pos:"MF", posFull:"Central Mid",   age:25, nation:"Botswana",    club:"Mamelodi Sundowns", leagueId:"rsa1",  mv:"€1.2M", mvNum:1.2,  expiry:"2027-06", status:"Active",        agent:"Donte Dorlly",   rating:7.1, apps:26, goals:4,  assists:9,  passAcc:85, mins:2200, height:"1.77m", foot:"Right", tier:"key",     form:0.9}),
    P({name:"Ndima Nkomokazi",     pos:"FW", posFull:"Forward",       age:24, nation:"South Africa", club:"Jomo Cosmos",       leagueId:"rsa1",  mv:"€0.5M", mvNum:0.5,  expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",   rating:6.9, apps:22, goals:9,  assists:3,  passAcc:78, mins:1850, height:"1.80m", foot:"Right", tier:"squad",   form:1.1}),
    P({name:"Chukwuemeka Obioma",  pos:"FW", posFull:"Striker",       age:23, nation:"Nigeria",      club:"Abia Warriors F.C", leagueId:"nga1",  mv:"€0.5M", mvNum:0.5,  expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",   rating:7.0, apps:24, goals:12, assists:4,  passAcc:76, mins:2020, height:"1.86m", foot:"Right", tier:"squad",   form:1.2}),
    P({name:"Lyema Dopolo",        pos:"DF", posFull:"Defender",      age:21, nation:"South Africa", club:"Ongoes F.C",        leagueId:"nam1",  mv:"€0.4M", mvNum:0.4,  expiry:"2026-06", status:"Prospect",      agent:"Donte Dorlly",    rating:6.8, apps:20, goals:1,  assists:2,  passAcc:83, mins:1720, height:"1.82m", foot:"Right", tier:"prospect",form:1.5}),
    P({name:"Ibrahim Buhari",      pos:"DF", posFull:"Centre-Back",   age:24, nation:"Ghana",        club:"IF Elfsborg",       leagueId:"swe1",  mv:"€2.5M", mvNum:2.5,  expiry:"2027-06", status:"Active",        agent:"Donte Dorlly",    rating:7.1, apps:22, goals:2,  assists:1,  passAcc:87, mins:1880, height:"1.91m", foot:"Right", tier:"key",     form:0.7}),
    P({name:"Sana Gomes",          pos:"DF", posFull:"Defender",      age:23, nation:"Senegal",      club:"Hapoel Haifa",      leagueId:"isr1",  mv:"€1.0M", mvNum:1.0,  expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",    rating:6.9, apps:21, goals:1,  assists:2,  passAcc:84, mins:1800, height:"1.84m", foot:"Left",  tier:"squad",   form:0.5}),
    P({name:"Jacob Everson",       pos:"MF", posFull:"Central Mid",   age:23, nation:"Botswana",    club:"Jwaneng Galaxy F.C",leagueId:"bwa1",  mv:"€0.3M", mvNum:0.3,  expiry:"2026-06", status:"Prospect",      agent:"Donte Dorlly",    rating:6.8, apps:20, goals:3,  assists:5,  passAcc:80, mins:1720, height:"1.80m", foot:"Right", tier:"prospect",form:1.6}),
    P({name:"Mashiku Hans Muyeka", pos:"FW", posFull:"Forward",       age:24, nation:"Zambia",       club:"Mighty Gunners FC", leagueId:"zmb1",  mv:"€0.4M", mvNum:0.4,  expiry:"2026-06", status:"Active",        agent:"Donte Dorlly",    rating:6.9, apps:22, goals:10, assists:3,  passAcc:77, mins:1880, height:"1.81m", foot:"Right", tier:"squad",   form:1.0}),
    P({name:"Derrick Owusu",       pos:"MF", posFull:"Midfielder",    age:22, nation:"Ghana",        club:"Accra Lions",       leagueId:"gha1",  mv:"€0.6M", mvNum:0.6,  expiry:"2026-06", status:"Prospect",      agent:"Donte Dorlly", rating:6.9, apps:23, goals:5,  assists:7,  passAcc:82, mins:1980, height:"1.76m", foot:"Right", tier:"prospect",form:1.8}),
    P({name:"Marcelino Abrahams",  pos:"FW", posFull:"Winger",        age:27, nation:"South Africa", club:"Free Agent",        leagueId:"",      mv:"—",     mvNum:0,    expiry:"—",       status:"Active",        agent:"Donte Dorlly", rating:7.0, apps:0,  goals:0,  assists:0,  passAcc:79, mins:0,    height:"1.73m", foot:"Right", tier:"squad",   form:0.8}),
    P({name:"Lindokuhle Zungu",    pos:"FW", posFull:"Winger",        age:20, nation:"South Africa", club:"Houtbay F.C",       leagueId:"rsa1",  mv:"€0.3M", mvNum:0.3,  expiry:"2026-06", status:"Prospect",      agent:"Donte Dorlly", rating:6.8, apps:19, goals:7,  assists:4,  passAcc:80, mins:1620, height:"1.75m", foot:"Left",  tier:"prospect",form:2.0}),
    P({name:"Laudry Mukaba",       pos:"FW", posFull:"Winger",        age:22, nation:"DR Congo",     club:"African Stars F.C", leagueId:"nam1",  mv:"€0.4M", mvNum:0.4,  expiry:"2026-06", status:"Active",        agent:"Donte Dorlly", rating:6.9, apps:21, goals:8,  assists:5,  passAcc:79, mins:1780, height:"1.72m", foot:"Right", tier:"squad",   form:1.3}),
    P({name:"Luke Daniels",        pos:"FW", posFull:"Striker",       age:21, nation:"South Africa", club:"AmaTuks F.C",       leagueId:"rsa1",  mv:"€0.3M", mvNum:0.3,  expiry:"2026-06", status:"Prospect",      agent:"Donte Dorlly", rating:6.8, apps:18, goals:7,  assists:3,  passAcc:77, mins:1440, height:"1.83m", foot:"Right", tier:"prospect",form:2.2}),
  ];
  ...
  const AGENTS = [
    {name:"Donte Dorlly",  role:"Founder & Lead Agent",   players:34, value:"€349M", av:"#1f3aa6", initials:"DD"},
  ];
