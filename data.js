...
(function () {
  ...
  const PLAYERS = [
    ...
    P({name:"Mateo Rivas",     pos:"FW", posFull:"Forward",      age:21, nation:"Argentina",  club:"Atlético Verano",   leagueId:"por1",    mv:"€42.0M", mvNum:42,   expiry:"2027-06", status:"Active",        agent:"—",   rating:7.9, apps:28, goals:19, assists:7,  passAcc:81, mins:2380, height:"1.83m", foot:"Right", tier:"elite",   form:1.6}),
    P({name:"Luka Veselin",    pos:"MF", posFull:"Att. Midfield", age:23, nation:"Croatia",    club:"Olympia Nord",      leagueId:"den1",    mv:"€31.5M", mvNum:31.5, expiry:"2026-06", status:"Active",        agent:"—",    rating:7.6, apps:31, goals:8,  assists:14, passAcc:89, mins:2710, height:"1.79m", foot:"Left",  tier:"key",     form:1.1}),
    P({name:"Idriss Camara",   pos:"DF", posFull:"Centre-Back",  age:24, nation:"Senegal",    club:"Ribera CF",         leagueId:"esp2",    mv:"€24.0M", mvNum:24,   expiry:"2025-12", status:"Contract Risk", agent:"—",   rating:7.3, apps:30, goals:2,  assists:1,  passAcc:91, mins:2700, height:"1.91m", foot:"Right", tier:"key",     form:0.5}),
    P({name:"Théo Lamballe",   pos:"GK", posFull:"Goalkeeper",   age:26, nation:"France",     club:"Meridian City",     leagueId:"bel1",    mv:"€18.5M", mvNum:18.5, expiry:"2028-06", status:"Active",        agent:"—",    rating:7.4, apps:29, goals:0,  assists:0,  passAcc:78, mins:2610, height:"1.94m", foot:"Right", tier:"key",     form:0.3}),
    P({name:"Bruno Sável",     pos:"FW", posFull:"Winger",       age:19, nation:"Portugal",   club:"Falcão SC",         leagueId:"por2",    mv:"€15.0M", mvNum:15,   expiry:"2027-06", status:"Prospect",      agent:"—", rating:7.1, apps:24, goals:9,  assists:11, passAcc:83, mins:1980, height:"1.75m", foot:"Right", tier:"prospect",form:2.1}),
    P({name:"Adewale Okoye",   pos:"MF", posFull:"Def. Midfield",age:22, nation:"Nigeria",    club:"Vallensa United",   leagueId:"ned2",    mv:"€22.0M", mvNum:22,   expiry:"2026-12", status:"Active",        agent:"—",   rating:7.5, apps:33, goals:3,  assists:5,  passAcc:88, mins:2890, height:"1.85m", foot:"Right", tier:"key",     form:0.8}),
    P({name:"Niklas Brandt",   pos:"DF", posFull:"Right-Back",   age:25, nation:"Germany",    club:"Köln Adler",        leagueId:"ger2",    mv:"€16.5M", mvNum:16.5, expiry:"2026-06", status:"Active",        agent:"—",    rating:7.2, apps:27, goals:1,  assists:6,  passAcc:85, mins:2380, height:"1.81m", foot:"Right", tier:"squad",   form:0.6}),
    P({name:"Rafael Pinto",    pos:"FW", posFull:"Striker",      age:28, nation:"Brazil",     club:"Porto Azul",        leagueId:"por1",    mv:"€28.0M", mvNum:28,   expiry:"2025-06", status:"Contract Risk", agent:"—", rating:7.7, apps:30, goals:21, assists:4,  passAcc:79, mins:2540, height:"1.88m", foot:"Left",  tier:"key",     form:0.9}),
    P({name:"Joel Hartman",    pos:"MF", posFull:"Central Mid",  age:20, nation:"England",    club:"Highmoor FC",       leagueId:"swe1",    mv:"€19.0M", mvNum:19,   expiry:"2028-06", status:"Prospect",      agent:"—",   rating:7.0, apps:22, goals:4,  assists:8,  passAcc:86, mins:1760, height:"1.80m", foot:"Right", tier:"prospect",form:1.8}),
    P({name:"Diego Marín",     pos:"DF", posFull:"Centre-Back",  age:27, nation:"Spain",      club:"Cádiz Marina",      leagueId:"esp2",    mv:"€12.0M", mvNum:12,   expiry:"2026-06", status:"Active",        agent:"—",    rating:7.1, apps:28, goals:3,  assists:0,  passAcc:90, mins:2520, height:"1.89m", foot:"Right", tier:"squad",   form:0.4}),
    P({name:"Yuki Tanabe",     pos:"MF", posFull:"Winger",       age:21, nation:"Japan",      club:"Vento FC",          leagueId:"aut1",    mv:"€17.5M", mvNum:17.5, expiry:"2027-06", status:"Active",        agent:"—", rating:7.3, apps:29, goals:7,  assists:10, passAcc:84, mins:2340, height:"1.72m", foot:"Left",  tier:"key",     form:1.4}),
    P({name:"Karim El Fassi",  pos:"FW", posFull:"Forward",      age:23, nation:"Morocco",    club:"Lyonne AC",         leagueId:"fra3",    mv:"€26.5M", mvNum:26.5, expiry:"2027-12", status:"Active",        agent:"—",   rating:7.6, apps:31, goals:15, assists:9,  passAcc:82, mins:2680, height:"1.84m", foot:"Right", tier:"key",     form:1.3}),
    P({name:"Anton Skov",      pos:"FW", posFull:"Striker",      age:18, nation:"Norway",     club:"Nordvik IF",        leagueId:"den1",    mv:"€9.5M",  mvNum:9.5,  expiry:"2027-06", status:"Prospect",      agent:"—", rating:6.9, apps:19, goals:11, assists:3,  passAcc:77, mins:1480, height:"1.90m", foot:"Right", tier:"prospect",form:2.4}),
    P({name:"Felipe Andrade",  pos:"DF", posFull:"Left-Back",    age:24, nation:"Brazil",     club:"Delta Lagos",       leagueId:"lat1",    mv:"€14.0M", mvNum:14,   expiry:"2026-06", status:"Active",        agent:"—",    rating:7.0, apps:26, goals:2,  assists:7,  passAcc:84, mins:2300, height:"1.78m", foot:"Left",  tier:"squad",   form:0.7}),
    P({name:"Sergio Bonilla",  pos:"MF", posFull:"Att. Midfield",age:26, nation:"Colombia",   club:"Estrella Roja",     leagueId:"esp3",    mv:"€20.5M", mvNum:20.5, expiry:"2025-12", status:"Contract Risk", agent:"—",   rating:7.4, apps:30, goals:10, assists:12, passAcc:87, mins:2610, height:"1.76m", foot:"Right", tier:"key",     form:0.6}),
    P({name:"Lars Ophoven",    pos:"DF", posFull:"Centre-Back",  age:22, nation:"Netherlands",club:"Borges United",     leagueId:"ned2",    mv:"€13.5M", mvNum:13.5, expiry:"2028-06", status:"Prospect",      agent:"—", rating:7.0, apps:25, goals:1,  assists:2,  passAcc:89, mins:2200, height:"1.92m", foot:"Left",  tier:"prospect",form:1.5}),
    P({name:"Emiliano Sosa",   pos:"GK", posFull:"Goalkeeper",   age:29, nation:"Uruguay",    club:"Saint-Croix",       leagueId:"bel2",    mv:"€10.0M", mvNum:10,   expiry:"2026-06", status:"Active",        agent:"—",    rating:7.2, apps:30, goals:0,  assists:0,  passAcc:75, mins:2700, height:"1.93m", foot:"Right", tier:"squad",   form:0.2}),
    P({name:"Gabriel Nunes",   pos:"FW", posFull:"Winger",       age:20, nation:"Brazil",     club:"Maple Rovers",      leagueId:"swe1",    mv:"€21.0M", mvNum:21,   expiry:"2027-06", status:"Active",        agent:"—",   rating:7.4, apps:27, goals:12, assists:8,  passAcc:80, mins:2280, height:"1.74m", foot:"Right", tier:"key",     form:1.7}),
    ...
    P({name:"Cheick Oumar Konaté", pos:"DF", posFull:"Centre-Back",  age:25, nation:"Mali",         club:"A.E. Kifisia",      leagueId:"gre2",  mv:"€1.2M", mvNum:1.2,  expiry:"2026-06", status:"Active",        agent:"—",   rating:7.0, apps:24, goals:1,  assists:1,  passAcc:85, mins:2100, height:"1.88m", foot:"Right", tier:"squad",   form:0.6}),
  ...
  const AGENTS = [
    {name:"Donte Dorlly",  role:"Founder & Lead Agent",   players:15, value:"€11.7M", av:"#1f3aa6", initials:"DD"},
  ];
