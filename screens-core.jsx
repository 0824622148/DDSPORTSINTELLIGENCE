...
function Login({ onLogin }) {
  ...
  const roles = [
    { id: "owner", label: "Agency Owner", icon: "briefcase" },
    { id: "scout", label: "Scout", icon: "search" },
    { id: "player", label: "Player", icon: "shield" },
  ];
    ...
    <div className="login">
      ...
      <div className="login-form-wrap">
        <form className="login-form" onSubmit={submit}>
          <h1>Sign in</h1>
          <p className="lead">Welcome back. Select your role to continue.</p>
          ...
          <div className="form-group">
            ...
            <input className="form-input" type="email" defaultValue={role + "@ddsports.agency"} />
          </div>
          <div className="form-group">
